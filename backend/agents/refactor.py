...
class RefactorAgent:
    ...
    async def refactor(self, code: str, instruction: str,
        ...
        prompt = (
            ...
            "7. If refactoring affects MULTIPLE files, output code for ALL affected files\n\n"
            "CRITICAL OUTPUT FORMAT: For EVERY code block, specify the target file and action:\n\n"
            "Действие: заменить\n"
            ...
            "refactored code\n"
            "```\n\n"
            "You MUST include Действие, Файл, and Строки before EVERY code block.\n\n"
            "Output format:\n"
            "1. Brief explanation of changes and why\n"
            "2. Complete refactored code with file/line metadata for each block\n"
